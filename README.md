...
```sh
grep -rl 'AlgoliaVue' ./ | xargs sed -i '' 's/AlgoliaVue/{YOUR INTEGRATION NAME}/g'
```
...
Want to contribute? Ping us on `AlgoliaVue` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/AlgoliaVue.git
    cd AlgoliaVue
    ```
...
- [AlgoliaVue integration Documentation](https://docs.vuestorefront.io/AlgoliaVue)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `AlgoliaVue` channel on [our Discord](discord.vuestorefront.io).
